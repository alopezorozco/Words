...
import com.example.wordsapp.databinding.FragmentLettersListBinding
...
class LettersListFragment : Fragment() {
     ...
     */
    private var _binding : FragmentLettersListBinding? = null;
    ...
    override fun onCreateView(
        ...
        _binding = FragmentLettersListBinding.inflate(inflater, container, false)
